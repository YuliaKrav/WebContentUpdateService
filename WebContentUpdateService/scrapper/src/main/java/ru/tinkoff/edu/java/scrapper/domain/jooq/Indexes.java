...
public class Indexes {
    ...
    public static final Index LINKS_UNIQUE_URL_PER_CHAT = Internal.createIndex(DSL.name("LINKS_UNIQUE_URL_PER_CHAT"), Links.LINKS, new OrderField[] { Links.LINKS.URL, Links.LINKS.ID_CHAT }, true);
}

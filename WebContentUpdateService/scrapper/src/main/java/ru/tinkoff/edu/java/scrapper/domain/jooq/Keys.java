...
public class Keys {
    ...
    public static final UniqueKey<ChatsRecord> CONSTRAINT_3 = Internal.createUniqueKey(Chats.CHATS, DSL.name("CONSTRAINT_3"), new TableField[] { Chats.CHATS.CHAT_NUMBER }, true);
    ...
    public static final ForeignKey<LinksRecord, ChatsRecord> CONSTRAINT_45 = Internal.createForeignKey(Links.LINKS, DSL.name("CONSTRAINT_45"), new TableField[] { Links.LINKS.ID_CHAT }, Keys.CONSTRAINT_3, new TableField[] { Chats.CHATS.CHAT_NUMBER }, true);
}

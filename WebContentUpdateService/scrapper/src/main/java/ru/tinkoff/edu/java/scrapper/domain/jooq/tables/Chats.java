...
public class Chats extends TableImpl<ChatsRecord> {
     ...
     */
    public final TableField<ChatsRecord, Integer> CHAT_NUMBER =
        createField(DSL.name("CHAT_NUMBER"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>CHATS.USER_NAME</code>.
     */
    public final TableField<ChatsRecord, String> USER_NAME =
        createField(DSL.name("USER_NAME"), SQLDataType.VARCHAR(300), this, "");

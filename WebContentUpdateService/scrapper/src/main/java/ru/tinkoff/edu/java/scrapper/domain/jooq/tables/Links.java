...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, String> URL = createField(DSL.name("URL"), SQLDataType.VARCHAR(1000).nullable(false), this, "");

    /**
     * The column <code>LINKS.LAST_UPDATE_DATE</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_UPDATE_DATE = createField(DSL.name("LAST_UPDATE_DATE"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINKS.ID_CHAT</code>.
     */
    public final TableField<LinksRecord, Integer> ID_CHAT = createField(DSL.name("ID_CHAT"), SQLDataType.INTEGER, this, "");
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super Integer, ? super String, ? super OffsetDateTime, ? super Integer, ? extends U> from) {
